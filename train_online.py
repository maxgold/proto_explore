...
from replay_buffer import ReplayBufferStorage, make_replay_loader_online
...
class Workspace:
    def __init__(self, cfg):
        ...
        if cfg.use_wandb:
            ...
            wandb.init(project="og", group=cfg.agent.name, name=exp_name)
        ...
        # create replay buffer
        self.replay_loader = make_replay_loader_online(self.replay_storage,
        ...
        self.video_recorder = VideoRecorder(
            self.work_dir if cfg.save_video else None, use_wandb=cfg.use_wandb)
        self.train_video_recorder = TrainVideoRecorder(
            self.work_dir if cfg.save_train_video else None, use_wandb=cfg.use_wandb)
...
@hydra.main(config_path='.', config_name='online')
def main(cfg):
    from train_online import Workspace as W
    root_dir = Path.cwd()
    workspace = W(cfg)
