...
@SUITE.add('benchmarking')
def reach_hard2_no_goal_v1(time_limit=_DEFAULT_TIME_LIMIT,
              random=None,
                init_state=None,
              environment_kwargs=None):
    """Returns the Run task."""
...
@SUITE.add('benchmarking')
def reach_hard2_no_goal_v2(time_limit=_DEFAULT_TIME_LIMIT,
              random=None,
                init_state=None,
              environment_kwargs=None):
    """Returns the Run task."""
    ...
    task = MultiTaskPointMassMaze(target_id=17, random=random, init_state=init_state)
    environment_kwargs = environment_kwargs or {}
    return control.Environment(physics,
                               task,
                               time_limit=time_limit,
...
@SUITE.add('benchmarking')
def reach_room_no_goal_v2(time_limit=_DEFAULT_TIME_LIMIT,
              random=None,
                init_state=None,
              environment_kwargs=None):
    """Returns the Run task."""
...
class MultiTaskPointMassMaze(base.Task):
    ...
    def __init__(self, target_id=None, random=None, target_loc=None, init_state=None):
        ...
        if init_state is None:
            ...
            print('init random', self._init_state)
