...
def make_agent(obs_type, obs_spec, action_spec, goal_shape, num_expl_steps, cfg, lr=.0001, hidden_dim=1024,
               num_protos=512,
               update_gc=2, tau=.1, num_iterations=3, feature_dim=50, pred_dim=128,
               proj_dim=512,
               batch_size=1024, update_proto_every=10,
               stddev_schedule=.2,
               ...
               normalize=False, normalize2=False, feature_dim_gc=50, inv=False, sl=False, encoder1=False,
               encoder2=False, encoder3=False, use_actor_trunk=False, use_critic_trunk=False):
