...
class Workspace:
    def __init__(self, cfg, critic1, actor1):
        self.work_dir = Path.cwd()
        print(f'workspace: {self.work_dir}')

        self.cfg = cfg
        self.critic1_path = critic1
        self.actor1_path = actor1
...
#               nstep, discount, reward_scores, reward_euclid, num_seed_frames, task_no_goal, , goal_queue_size
    ...
    # create agent
        ...
        self.agent.critic1 = torch.load(self.critic1_path)
        self.agent.actor1 = torch.load(self.actor1_path)
    ...
    def train(self):
        # predicates
        print('modelname', self.critic1_path.split('/')[-2])
        self.agent.pairwise_eval_mode(1000000, self.critic1_path.split('/')[-2])
...
def main(cfg):
    from eval_proto_gc import Workspace as W
    root_dir = Path.cwd()

    nested_lst=[['/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/191231_proto_goal_gc/critic1_proto_goal_gc_1000000.pth', '/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/191231_proto_goal_gc/actor1_proto_goal_gc_1000000.pth'],
            ['/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/191009_proto_goal_gc/critic1_proto_goal_gc_1000000.pth','/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/191009_proto_goal_gc/actor1_proto_goal_gc_1000000.pth'],

    ['/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/183734_proto_goal_gc/critic1_proto_goal_gc_1000000.pth',
    '/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/183734_proto_goal_gc/actor1_proto_goal_gc_1000000.pth'],
    
    ['/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/183649_proto_goal_gc/critic1_proto_goal_gc_1000000.pth',
    '/home/nina/proto_explore/url_benchmark/exp_local/2022.09.28/183649_proto_goal_gc/actor1_proto_goal_gc_1000000.pth']]
    print(nested_lst[0][0].split('/')[-2])
    for x in nested_lst:
        print('nested lst', nested_lst)
        workspace = W(cfg,x[0], x[1])
        workspace.train()
